...
const settingsSchema = new mongoose.Schema({
    shopName: { type: String, default: 'My Silk Store' },
    phone: { type: String, default: '9876543210' },
    address1: { type: String, default: '123, Silk Street' },
    address2: { type: String, default: 'Kanchipuram - 631501' },
    ...
    billPrefix: { type: String, default: 'SILK-' },
    autoBackup: { type: Boolean, default: true },
    primaryColor: { type: String, default: '#7c2d12' },
    backgroundPattern: { type: String, default: 'silk' },
    visibleWidgets: {
